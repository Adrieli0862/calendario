...
$('#formEventButton').click(function (event) {
  ...
  payload.append('sede',usr.id_sede);
  $.ajax({
   type: "POST",
...
function doMonthPill(event,time) {
  ...
  div.addEventListener("click",function name(e) {
    ...
    document.getElementById('eventHoursLocal').innerText=dateFromLocal.toLocaleString();
    document.getElementById('eventDay').innerText=dateTo;
    document.getElementById('eventDayLocal').innerText=dateToLocal.toLocaleString();
